...
},{"../node_modules/aos/dist/aos.css":"Jk0R"}],"a7Yf":[function(require,module,exports) {
var define;
...
exports.bigScreen = void 0;

var _lodash = _interopRequireDefault(require("lodash.debounce"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var bigScreen = function bigScreen() {
  return window.innerWidth >= 576;
};

exports.bigScreen = bigScreen;
window.addEventListener("resize", (0, _lodash.default)(function () {
  if (bigScreen()) {
...
},{"lodash.debounce":"TZhv"}],"C1P0":[function(require,module,exports) {
// import AOS from "aos";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./esm/components/core/core-class":"EVXA","./esm/components/virtual/virtual":"FIhR","./esm/components/keyboard/keyboard":"TV3J","./esm/components/mousewheel/mousewheel":"e2K7","./esm/components/navigation/navigation":"lI3j","./esm/components/pagination/pagination":"Xygp","./esm/components/scrollbar/scrollbar":"IGop","./esm/components/parallax/parallax":"IkWW","./esm/components/zoom/zoom":"NVkY","./esm/components/lazy/lazy":"DZFq","./esm/components/controller/controller":"TFN1","./esm/components/a11y/a11y":"xnqx","./esm/components/history/history":"hpIj","./esm/components/hash-navigation/hash-navigation":"IH1G","./esm/components/autoplay/autoplay":"qBPE","./esm/components/effect-fade/effect-fade":"NuJS","./esm/components/effect-cube/effect-cube":"lyrG","./esm/components/effect-flip/effect-flip":"KXCu","./esm/components/effect-coverflow/effect-coverflow":"Pg6T","./esm/components/thumbs/thumbs":"cNwX"}],"tMTn":[function(require,module,exports) {
"use strict";
...
var imageSliders = document.querySelectorAll(".single-image-slider");
...
},{"swiper":"MGWF","swiper/swiper-bundle.min.css":"Jk0R","animejs/lib/anime.es.js":"tMTn"}],"z8X6":[function(require,module,exports) {
var define;
...
},{}],"PDbM":[function(require,module,exports) {
"use strict";
...
},{"simple-parallax-js":"z8X6"}],"i0CD":[function(require,module,exports) {
"use strict";
...
var navLink = document.querySelectorAll(".main-nav li a");
navLink.forEach(function (link) {
  link.addEventListener("click", function () {
    closeMenu();
  });
});
},{"animejs/lib/anime.es.js":"tMTn"}],"N8YO":[function(require,module,exports) {
"use strict";
...
},{"lodash.debounce":"TZhv"}],"ihtJ":[function(require,module,exports) {
/**
 * Checks if `value` is the
 * [language type](http://www.ecma-international.org/ecma-262/7.0/#sec-ecmascript-language-types)
 * of `Object`. (e.g. arrays, functions, objects, regexes, `new Number(0)`, and `new String('')`)
...
},{"./_root":"M4cY"}],"bNFp":[function(require,module,exports) {
...
},{"./_trimmedEndIndex":"bNFp"}],"ydxh":[function(require,module,exports) {
var root = require('./_root');
...
},{"./_baseTrim":"lyYi","./isObject":"ihtJ","./isSymbol":"DFEd"}],"o1J2":[function(require,module,exports) {
...
},{"./isObject":"ihtJ","./now":"gRBa","./toNumber":"K9rX"}],"ahRD":[function(require,module,exports) {
"use strict";
...
var stickyBoxes = document.querySelectorAll(".sticky-content .contentbox");
var stickyBoxTitles = document.querySelectorAll(".sticky-content .contentbox .text h4");
var stickyHeaderTitle = document.querySelector(".sticky-header h2");
window.addEventListener("scroll", (0, _debounce.default)(function () {
  stickyBoxes.forEach(function (box, i) {
    if (isInView(box)) {
      var title = stickyBoxTitles[i];
      stickyHeaderTitle.textContent = title.textContent;
    }
  });
}, 20));
},{"lodash/debounce":"o1J2"}],"QdeU":[function(require,module,exports) {
"use strict";
...
require("./sticky");
},{"../scss/app.scss":"qlE7","boxicons/dist/boxicons":"a7Yf","./utils":"MgTz","./animation":"C1P0","./slider":"wzuc","./parallax":"PDbM","./menu":"i0CD","./scroll":"N8YO","./sticky":"ahRD"}]},{},["QdeU"], null)